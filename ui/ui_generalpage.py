...
# coding=UTF-8
#
# Generated by pykdeuic4 from ui/generalpage_new.ui on Sat Oct 24 15:11:13 2009
#
...
class Ui_GeneralPage(object):
    def setupUi(self, GeneralPage):
        ...
        self.kcfg_displayColumns.setMaximum(10)
        self.kcfg_displayColumns.setProperty("value", 3)
        self.kcfg_displayColumns.setObjectName("kcfg_displayColumns")
        self.formLayout.setWidget(0, QtGui.QFormLayout.FieldRole, self.kcfg_displayColumns)
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.kcfg_thumbnailMaxRetrieve)
