...
class Ui_GeneralPage(object):
    def setupUi(self, GeneralPage):
        ...
        self.kcfg_danbooruUrls.setButtons(KEditListBox.Buttons(KEditListBox.Add|KEditListBox.Remove))
        ...
        self.kcfg_thumbnailMaxRetrieve = KIntNumInput(self.groupBox)
        ...
        self.gridLayout.addWidget(self.kcfg_thumbnailMaxRetrieve, 0, 1, 1, 1)
